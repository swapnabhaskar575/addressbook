Hello There!!Addressbook Tutorial
====================
...
- The URL to use is https://github.com/ranaskr/addressbook.git
...
- Team -> Git -> Clone
- Set repository URL to https://github.com/ranaskr/addressbook.git
- Finish
...
- Set the repository URL to https://github.com/ranaskr/addressbook.git
